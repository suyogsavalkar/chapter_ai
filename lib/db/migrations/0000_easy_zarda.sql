...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "UserToolkit" (
	"userId" varchar(64) NOT NULL,
	"slug" varchar(64) NOT NULL,
	"enabled" boolean DEFAULT false NOT NULL,
	"updatedAt" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "UserToolkit_userId_slug_pk" PRIMARY KEY("userId","slug")
);
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "UserToolkit" ADD CONSTRAINT "UserToolkit_userId_User_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."User"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
